...
const { validateTaskCreational, validateId, validateTaskToUpdate } = require('../middlewares');
...
tasksRoute.put('/task/:id', validateId, validateTaskToUpdate, taskController.update);
